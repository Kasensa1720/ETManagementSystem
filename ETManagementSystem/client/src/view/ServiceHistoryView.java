...
public class ServiceHistoryView extends JFrame {
    ...
    private JTextField tuningJobIdField, notesField, performedByField;
 ...
 private MainDashboard mainDashboard; // ← Add this
    ...
    public ServiceHistory getServiceHistoryDetails() {
        try {
            ...
            return new ServiceHistory(0, tuningJobId, serviceType, notes, performedBy, serviceDate, tuningJobId);
